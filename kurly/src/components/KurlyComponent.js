...
import seach from '../img/ico_search.svg'
...
class KurlyComponent extends Component {
    ...
    onChangeId=(value)=>{
        ...
        this.idDoubleCheck(value);  //입력값 전달
    ...
    onClickModalClose1=(e)=>{
        ...
        if(this.state.휴대폰인증 === this.state.인증키){
            this.setState({isPhoneOkOpen: false});
        }else{
            this.setState({isPhoneOkOpen: true})
        }
    }
    //중복확인 이메일 클릭 모달 이벤트
        ...
        return (
            <div id="kurly">
                <form onSubmit={this.onSubmitEvent}>
                    <div className="title">
                        <h1><img src={require("../img/kurly_logo.svg").default}  alt="logo" /></h1>
                        <h2>회원가입</h2>
                    </div>
                            ...
                            <li>
                                <div className="gap">
                                    ...
                                    <div className="input-box radio-box">
                                       ...
                                       <label>
                                            <input type="radio" checked={this.state.추가입력사항.includes(`참여이벤트`)} value={`참여이벤트`}  onChange={(e) => this.onChangeChoocheon(e.target.value)}/>
                                            <span>참여이벤트</span>
                                       </label>
                                       {
                                        this.state.isAddInputBoxShow && (
                                            <div className='add-input-box'>
                                                <input type="text" className='inputText' id='addInputBox' placeholder={this.state.addInputPlaceHolder}
                                                value={this.state.추가입력상자} onChange={(e)=> this.onChangeAddInputBox(e.target.value)} />
                                            <p>
